...
\end{alltt}
\caption{Output of the RELAX program for the input parameters shown in Figure \ref{input:simple_coseismic}.}
...
EOF
\end{alltt}
The inclusion of unix commands in the input file allows more complex operations, such as filtering out data, shift, rotation and scaling of models, and others. An example complex coseismic slip distribution for the 1992 Mw 7.3 Landers earthquake can be found in the \verb'examples' directory.
...
% per science mag's guidelines, about 50 references
