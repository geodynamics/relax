...
2011 Mw\,9.1 Tohoku (Japan) & \cite{swei+12}\\
2011 Mw\,6.9 Tarlay (Myanmar) & \textit{Wang, pers. comm.} [2013]\\
2013 Mw\,8.6 Wharton Basin & \citep{swei+13}\\
\hline
\end{tabular}
\caption{Table of earthquake slip distribution with validated Relax input files. Slip distribution, Relax input for coseismic deformation and postseismic relaxation simulations, along with geographical information can be found in the \texttt{example} directory.}\label{tbl:input}
\end{table}
