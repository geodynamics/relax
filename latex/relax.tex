...
%MAIN PICTURE%
\begin{textblock*}{0in}(-0.14in,-2.5in)
% FILL: image height
% e.g. height=6.5in
\begin{center}
\vspace{.5in}
\includegraphics[height=8.5in]
...
% FILL: manual version
% e.g. 1.0
\raggedleft \huge \fontfamily{\sfdefault}\selectfont Version {1.0.7}\\}
%
%AUTHOR(S) & WEBSITE%
\null
\vfill
...
This document presents the background information to operate the Relax software and its associated post-processing tools and mapping functions. The document presents a succinct theoretical background, then describes how to produce simulations, including how to set up the runtime environment and the input parameters. Errors and bug fixes in this manual should be directed to the CIG Short Term Crustal Dynamics Mailing List (cig-short@geodynamics.org). Please specify which code and version you are using when reporting a problem.
...
{\color{NavyBlue}grdmath $\{index\}-s11p.grd 2 POW $\{index\}-s22p.grd 2 POW ADD $\{index\}-s33p.grd \textbackslash 
        ...
        $\{index\}-s23.grd 2 POW ADD SQRT = $\{index\}-tau.grd}
\end{alltt}
...
\hline
1906 M\,7.9 San Francisco & \cite{song+08}\\
1964 M\,9.2 Alaska & \cite{johnson+96}\\
%1984 M\,6.2 Morgan Hill & \cite{beroza&spudich88}\\
...
\bibitem[{\textit{Atzori et~al.}(2009)}]{atzori+09}
Atzori, S., et~al., {Finite fault inversion of DInSAR coseismic displacement of
  the 2009 L'Aquila earthquake (central Italy)}, \textit{Geophys. J. Int.},
  \textit{36}(15), 2009.

\bibitem[{\textit{Avouac et~al.}(2006)\textit{Avouac, Ayoub, Leprince, Konca,
  and Helmberger}}]{avouac+06}
Avouac, J.-P., F.~Ayoub, S.~Leprince, O.~Konca, and D.~V. Helmberger, {The
  2005, Mw 7.6 Kashmir earthquake: Sub-pixel correlation of ASTER images and
  seismic waveforms analysis}, \textit{Earth. Plan. Sc. Let.},
  \textit{249}(3-4), 514?528, 2006.

\bibitem[{\textit{Barbot and Fialko}(2010{\natexlab{a}})}]{barbot&fialko10a}
Barbot, S., and Y.~Fialko, {Fourier-domain Green's function for an elastic
...
\bibitem[{\textit{Barbot et~al.}(2008)\textit{Barbot, Hamiel, and
  Fialko}}]{barbot+08a}
Barbot, S., Y.~Hamiel, and Y.~Fialko, {Space geodetic investigation of the
  coseismic and postseismic deformation due to the 2003 Mw 7.2 Altai
  earthquake: Implications for the local lithospheric rheology}, \textit{J.
  Geophys. Res.}, \textit{113}(B03403), \doi{10.1029/2007JB005063}, 2008.
...
\bibitem[{\textit{B\'{e}jar-Pizarro et~al.}(2010)}]{beja-pizzarro+10}
...
\bibitem[{\textit{Beroza}(1991)}]{beroza91}
...
\bibitem[{\textit{Chlieh et~al.}(2007)}]{chlieh+07}
Chlieh, M., et~al., {Coseismic Slip and Afterslip of the Great Mw 9.15
  ...
  \textit{97}(1A), S152--S173, \doi{10.1785/0120050631}, 2007.
...
\bibitem[{\textit{Fialko}(2004)}]{fialko04c}
...
\bibitem[{\textit{Hudnut et~al.}(1996)}]{hudnut+96}
...
\bibitem[{\textit{Konca et~al.}(2007)\textit{Konca, Hjorleifsdottir, Song,
  Avouac, Helmberger, Ji, Sieh, Briggs, and Meltzner}}]{konca+07}
...
\bibitem[{\textit{Lasserre et~al.}(2005)\textit{Lasserre, Peltzer, Cramp\'{e},
...
\bibitem[{\textit{Lorito et~al.}(2011)\textit{Lorito, Romano, Atzori, Tong,
  Avallone, McCloskey, Cocco, Boschi, and Piatanesi}}]{lorito+11}
...
\bibitem[{\textit{Song et~al.}(2008)\textit{Song, Beroza, and
  Segall}}]{song+08}
...
\bibitem[{\textit{Steblov et~al.}(2010)\textit{Steblov, Vasilenko, Prytkov,
  Frolov, and Grekova}}]{steblov+10}
...
\bibitem[{\textit{Thomas et~al.}(2014)\textit{Thomas, Avouac, Champenois, Lee,
  and Kuo}}]{thomas+14}
...
\bibitem[{\textit{Tong et~al.}(2011)\textit{Tong, Sandwell, and
  Fialko}}]{tong+11}
...
\bibitem[{\textit{Wei et~al.}(2012)\textit{Wei, Graves, Helmberger, Avouac, and
  Jiang}}]{swei+12}
...
\bibitem[{\textit{Wei et~al.}(2013)\textit{Wei, Helmberger, and
  Avouac}}]{swei+13}
...
\bibitem[{\textit{Wei et~al.}(2011)}]{swei+11}
...
\bibitem[{\textit{Yamazaki et~al.}(2011)\textit{Yamazaki, Lay, Cheung, Yue, and
  Kanamori}}]{yamazaki+11}
