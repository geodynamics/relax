...
# convert the slip distribution of Moreno et al. (2009) for the 1960 Chile slip distribution
grep -v "#" moreno+09.flt | awk 'BEGIN{print "# n        slip          x1          x2          x3     length      width   strike      dip     rake"}{printf "%03d %11.4e %11.4e %11.4e %11.4e %10.4e %10.4e %8.3f %8.3f %8.3f\n",NR,$2,$3/1e3,$4/1e3,$5/1e3,$6/1e3,$7/1e3,$8,$9,$10}' > moreno+09_km.flt
