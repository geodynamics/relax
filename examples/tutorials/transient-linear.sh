...
# map.sh -b -3/3/-3/3 transient-linear/000
#
# to visualize postseismic deformation (requires GRD output): 
# map.sh -b -5/5/-5/5 transient-linear/0{02,04,06,08}-relax
#
# type map.sh for a description of command-line options.
#

WDIR=./transient-linear
...
0
# number of linear transient rheology interfaces
2
# n depth gammadot0  Gk
  1   2.0       1e0  30
  2   8.0       1e0  30
# number of transient linear ductile zones
0
