...
#   - local upper crustal thickness: 16 km
#   - local Moho depth (Owens & Zandt 1997): 55 km
#
...
OMP_NUM_THREADS=4 relax --no-stress-output $* <<EOF | tee $WDIR/in.param
...
1
# i depth gammadot0 cohesion
  1    20       0.1        0
# number of linear ductile zones
1
# i dgammadot0 x1  x2 x3 length width thickness strike dip
  1       -0.1 40 300 20    500    10       200    -81  90
