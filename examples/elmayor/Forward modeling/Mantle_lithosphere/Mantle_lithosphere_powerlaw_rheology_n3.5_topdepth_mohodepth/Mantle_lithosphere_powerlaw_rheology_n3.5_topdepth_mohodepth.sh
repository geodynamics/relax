...
# El Mayor-Cucapah earthquake: power-law (n=3.5) viscoelastic relaxation in mantle lithosphere geometry between Tape et al [2012] Moho surface and approximate Lekic et al [2011] lithosphere-asthenosphere boundary surface5
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Mantle_lithosphere_powerlaw_rheology_n3.5_topdepth_mohodepth
#PBS -q default
#PBS -l nodes=12
...
WDIR=./Mantle_lithosphere_powerlaw_rheology_n3.5_topdepth_mohodepth
...
`grep -v "#" ../../tape_mantlelith/mantlelith_moho_speed10000000.dat`
 401 -10000000 51.91 40.57 52.5   50   17.5     65    327  90
 402 -10000000 38.29 19.60 52.5   80   17.5     15    327  90
 403 -10000000 110 12.5  52.5  29  17.5   60    180  90
 404 -10000000 90  -35 45  75    25     25    180  90
 405 -10000000 35.41 15.41 45   400  25        125    147  90
 406 -10000000 28.76 4.92 45   80    25     20    327  90
 407 -10000000 12.42 -20.24 45   20    25     40    327  90
 408 -10000000 17.87 -11.85 45   40    25     20    327  90
