...
# El Mayor-Cucapah earthquake: Newtonian viscoelastic relaxation in narrow 3D ductile zone in mantle lithosphere aligned with locations of high heat flow and geothermal activity in Salton Trough; top depth 22.5 km (Tape et al Moho depth); bottom depth 45 km (Lekic et al LAB depth)
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Mantle_lithosphere_Newtonian_rheology_3D_geothermal
#PBS -q default
#PBS -l nodes=12
...
WDIR=./Mantle_lithosphere_Newtonian_rheology_3D_geothermal
...
# no dgammadot0 x1  x2 x3 length width thickness strike dip
   1      2.0  -18  30 22.5  110    20    30      335   90
   2      2.0  -18  30 22.5  400    20    30      147   90
