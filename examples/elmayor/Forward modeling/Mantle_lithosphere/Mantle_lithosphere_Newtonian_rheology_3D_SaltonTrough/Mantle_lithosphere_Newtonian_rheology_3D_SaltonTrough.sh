...
# El Mayor-Cucapah earthquake: Newtonian viscoelastic relaxation in 3D ductile zone in mantle lithosphere aligned with locations of shallow Lekic et al [2011] lithosphere-asthenosphere boundary; top depth 22.5 km (Tape et al Moho depth); bottom depth 45 km (Lekic et al LAB depth)
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Mantle_lithosphere_Newtonian_rheology_3D_SaltonTrough
#PBS -q default
#PBS -l nodes=12
...
WDIR=./Mantle_lithosphere_Newtonian_rheology_3D_SaltonTrough
...
# no dgammadot0 x1  x2 x3 length width thickness strike dip
   1       2.0 102.5 -28.16 22.5   400  22.5       125    147  90
   2      -2.5 119 -3 45   80    7.5     65    147  90
   3      -2.5 90  -70 22.5  70    22.5     45    180  90
   4      -2.5 110 40  22.5  30  22.5   100    0  90
   5      -2.5 55 130 22.5  400  22.5    130      147   90
