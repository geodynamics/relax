...
# El Mayor-Cucapah earthquake: rate-strengthening afterslip on downward extensions of planes F2 and F3 in Wei et al [2011] slip model, extending down approximately to Moho depth (~23-25 km depth), and on NW-striking vertical plane in Yuha Desert, extending from surface to 12 km depth; (a-b)sigma = 1 MPa
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Afterslip_beneathrupture_downtoMoho_plusYuhaDesert_downto12km_absig1
#PBS -q default
#PBS -l nodes=12
...
WDIR=./Afterslip_beneathrupture_downtoMoho_plusYuhaDesert_downto12km_absig1
...
# nb      x1       x2  x3 length width strike   dip rake
   ...
   3    +10.941  -25.585   0.083     24  12    305    90  180
