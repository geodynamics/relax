...
# El Mayor-Cucapah earthquake: rate-strengthening afterslip on downward extensions of planes F2 and F3 in Wei et al [2011] slip model and on NW-striking vertical plane in Yuha Desert, all extending down approximately to LAB depth (~45-50 km depth); (a-b)sigma = 10 MPa
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Afterslip_beneathrupture_downtoLAB_plusYuhaDesert_downtoLAB_absig10
#PBS -q default
#PBS -l nodes=12
...
WDIR=./Afterslip_beneathrupture_downtoLAB_plusYuhaDesert_downtoLAB_absig10
...
# nb      x1       x2  x3 length width strike   dip rake
   1   -23.289   20.286   14.572     51  33    311.2    75 -150
   2     -28.997  11.004   13.068    66   33    130      60 -150
   3    +10.941  -25.585   0.083     24  48    305    90  180
