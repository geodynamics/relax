...
# El Mayor-Cucapah earthquake: Newtonian viscoelastic relaxation in narrow ductile zone in the lower crust aligned with locations of high heat flow and geothermal activity in Salton Trough; top depth 10 km; bottom depth 22.5 km (Moho depth)
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Lower_crust_Newtonian_rheology_3D_geothermal_geometry_topdepth10km
#PBS -q default
#PBS -l nodes=12
...
WDIR=./Lower_crust_Newtonian_rheology_3D_geothermal_geometry_topdepth10km
...
# no dgammadot0 x1  x2 x3 length width thickness strike dip
   1       0.4  80 -15 10  110   12.5    30      155   90
   2       0.4 -18  30 10  400   12.5    30      147   90
