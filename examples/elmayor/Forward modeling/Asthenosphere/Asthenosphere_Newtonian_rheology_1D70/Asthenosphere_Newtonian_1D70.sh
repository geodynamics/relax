...
# El Mayor-Cucapah earthquake: Newtonian viscoelastic relaxation below 70 km depth
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Asthenosphere_Newtonian_rheology_1D70
...
WDIR=./Asthenosphere_Newtonian_rheology_1D70
