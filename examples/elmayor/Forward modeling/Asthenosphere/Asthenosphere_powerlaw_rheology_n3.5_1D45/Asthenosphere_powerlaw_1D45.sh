...
# El Mayor-Cucapah earthquake: power-law (n=3.5) viscoelastic relaxation below 45 km depth
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Asthenosphere_powerlaw_rheology_n3.5_1D45
...
WDIR=./Asthenosphere_powerlaw_rheology_n3.5_1D45
