...
# El Mayor-Cucapah earthquake: power-law (n=3.5) viscoelastic relaxation in region of shallow Lekic et al [2011] lithosphere-asthenosphere boundary geometry in the Salton Trough plus beneath 70 km depth outside Salton Trough
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Asthenosphere_powerlaw_rheology_n3.5_ST+
...
WDIR=./Asthenosphere_powerlaw_rheology_n3.5_ST+
...
# no depth gammadot0 power cohesion
   1   70  1000000000  3.5      0.0
# number of linear ductile zones
5
# no dgammadot0 x1  x2 x3 length width thickness strike dip
   1  1000000000 102.5 -28.16 45   400  25       125    147  90
   2 -1000000000 119 -3 45   80    7.5     65    147  90
   3 -1000000000 90  -70 45  70    25     45    180  90
   4 -1000000000 110 40  45  30  25   100    0  90
   5 -1000000000 55 130 45  400  25    130      147   90
