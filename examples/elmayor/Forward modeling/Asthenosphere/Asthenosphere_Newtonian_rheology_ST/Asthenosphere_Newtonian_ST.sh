...
# El Mayor-Cucapah earthquake: Newtonian viscoelastic relaxation in region of shallow Lekic et al [2011] lithosphere-asthenosphere boundary geometry in the Salton Trough
# Note that the grid is 1024^3, which requires >50 GB of RAM on one node. If that exceeds capabilities, try setting sx3 to 512.

#PBS -N Asthenosphere_Newtonian_rheology_ST
...
WDIR=./Asthenosphere_Newtonian_rheology_ST
...
# no dgammadot0 x1  x2 x3 length width thickness strike dip
   1       1.8 102.5 -28.16 45   400  300       125    147  90
   2      -2.5 119 -3 45   80    7.5     65    147  90
   3      -2.5 90  -70 45  70    300     45    180  90
   4      -2.5 110 40  45  30  300   100    0  90
   5      -2.5 55 130 45  400  300    130      147   90
