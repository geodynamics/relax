...
# El Mayor-Cucapah earthquake: Newtonian viscoelastic relaxation below 45 km depth in region of shallow Lekic et al [2011] lithosphere-asthenosphere boundary geometry in the Salton Trough and below 70 km depth outside the Salton Trough
...
# no dgammadot0 x1  x2 x3 length width thickness strike dip
   1       1.8 102.5 -28.16 45   400  25       125    147  90
